		...
		-->
	    	...
	    	<div class="sidebar-wrapper">
				...
				<ul class="nav">
					@if(Route::is('home') )
						<li class="active">
							<a href="{{route('GetDashboardProfessionnel')}}">
					...
					<li class="">
						...
						<div class="collapse" id="BulletinOverview">
							<ul class="nav">
								...
								@foreach($allApprentis as $apprentis)
								<li>
									<a href="">
										<span class="sidebar-normal">{{\App\Models\User::find($apprentis->eleve)->name}}</span>
									</a>
								</li>
								@endforeach
							</ul>
